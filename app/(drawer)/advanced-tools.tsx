...
const CATEGORIES = [
  ...
  },
  {
    ...
    modules: [
      { key: 'team', icon: 'person.3.fill', label: 'Equipos', color: '#52a67d', tier: 'pro' as PlanTier },
      { key: 'crm', icon: 'heart.fill', label: 'CRM', color: '#d66b6b', tier: 'pro' as PlanTier },
      { key: 'reports', icon: 'chart.pie.fill', label: 'Reportes', color: '#5ba3b8', tier: 'pro' as PlanTier },
      { key: 'client_portal', icon: 'globe', label: 'Portal Clientes', color: '#5ba3b8', tier: 'pro' as PlanTier },
      { key: 'distributor', icon: 'building.columns.fill', label: 'Distribuidor', color: '#e07a5f', tier: 'pro' as PlanTier },
      { key: 'marketing', icon: 'megaphone.fill', label: 'Marketing', color: '#e07a5f', tier: 'pro' as PlanTier },
      { key: 'payments', icon: 'creditcard.fill', label: 'Pasarelas Pago', color: '#5b7fc7', tier: 'pro' as PlanTier },
    ],
  },
  {
    id: 'premium',
    ...
    modules: [
      { key: 'accounting', icon: 'calculator', label: 'Contabilidad', color: '#d9a05b', tier: 'premium' as PlanTier },
      { key: 'workflows', icon: 'arrow.triangle.branch', label: 'Workflows', color: '#5b7fc7', tier: 'premium' as PlanTier },
      { key: 'predictions', icon: 'brain.head.profile', label: 'IA Avanzada', color: '#9b7fc9', tier: 'premium' as PlanTier },
    ],
  },
];
